...
GEMINI_API_KEY = os.getenv('API_KEY')  # Fetch API key from environment variables
...
def generate_signed_url(blob):
    """Generate a signed URL for accessing the file privately."""
    try:
...
def upload_file():
    if request.method == 'POST':
        ...
        try:
            ...
            if caption:
                ...
                print("No caption or description generated by Gemini API.")
    ...
    # Fetch images and their descriptions
    blobs = bucket.list_blobs()
    image_data_list = []
    print("Fetching images from the bucket...")
    ...
    for blob in blobs:
        if not blob.name.endswith('.txt'):
            ...
            if image_url:
                ...
                print(f"Failed to generate signed URL for image: {blob.name}")

    print("Completed fetching images.")
